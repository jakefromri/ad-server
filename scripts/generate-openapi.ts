...
async function main() {
  ...
  const routes: RouteDoc[] = [
    ...
    { method: 'get', path: '/api/admin/tenants', tags: ['Superadmin — Tenants'], summary: 'List all tenants', auth: 'superadmin', responseExample: { tenants: [] } },
    { method: 'post', path: '/api/admin/tenants', tags: ['Superadmin — Tenants'], summary: 'Create a tenant (atomically creates first tenant_admin invite)', auth: 'superadmin', requestSchema: createTenantSchema, responseExample: { tenant: {}, invite: { invite_url: 'https://...', expires_at: '2026-07-19T00:00:00.000Z' }, api_key: 'plaintext-shown-once' } },
    { method: 'patch', path: '/api/admin/tenants/{id}', tags: ['Superadmin — Tenants'], summary: 'Update tenant status/quota/timeout', auth: 'superadmin', requestSchema: patchTenantSchema, responseExample: { tenant: {} } },
    { method: 'get', path: '/api/admin/tenants/{id}', tags: ['Superadmin — Tenants'], summary: 'Get a tenant with its campaigns and screens', auth: 'superadmin', responseExample: { tenant: {}, campaigns: [], screens: [] } },
    { method: 'post', path: '/api/admin/tenants/{id}/reinvite', tags: ['Superadmin — Tenants'], summary: 'Re-invite a tenant with no accepted tenant_admin', auth: 'superadmin', responseExample: { invite: { invite_url: 'https://...', expires_at: '2026-07-19T00:00:00.000Z' } } },
    { method: 'get', path: '/api/admin/ledger', tags: ['Superadmin — Ledger'], summary: 'Cross-tenant fulfillment ledger (paginated)', auth: 'superadmin', responseExample: { fulfillments: [], next_cursor: null } },
    { method: 'get', path: '/api/admin/system-health', tags: ['Superadmin — Ledger'], summary: 'Windowed system health metrics', auth: 'superadmin', responseExample: { request_rate_per_min: 0, error_rate: 0, reservation_timeout_rate: 0, no_eligible_campaign_rate: 0 } },
    { method: 'get', path: '/v1/campaigns', tags: ['Tenant — Campaigns'], summary: 'List campaigns', auth: 'tenant_admin JWT or tenant API key', responseExample: { campaigns: [] } },
    { method: 'post', path: '/v1/campaigns', tags: ['Tenant — Campaigns'], summary: 'Create a campaign', auth: 'tenant_admin JWT or tenant API key', requestSchema: createCampaignSchema, responseExample: { campaign: {} } },
    { method: 'patch', path: '/v1/campaigns/{id}', tags: ['Tenant — Campaigns'], summary: 'Update a campaign', auth: 'tenant_admin JWT or tenant API key', requestSchema: patchCampaignSchema, responseExample: { campaign: {} } },
    { method: 'get', path: '/v1/campaigns/{id}/pacing', tags: ['Tenant — Campaigns'], summary: 'Campaign pacing / delivery progress', auth: 'tenant_admin JWT or tenant API key', responseExample: { delivered: 0, remaining: null, sov_actual: null, sov_target: null, no_eligible_screens: false } },
    { method: 'get', path: '/v1/screens', tags: ['Tenant — Screens'], summary: 'List screens', auth: 'tenant_admin JWT or tenant API key', responseExample: { screens: [] } },
    { method: 'post', path: '/v1/screens', tags: ['Tenant — Screens'], summary: 'Register a screen', auth: 'tenant_admin JWT or tenant API key', requestSchema: screenBaseSchema, responseExample: { screen: {}, device_api_key: 'plaintext-shown-once' } },
    { method: 'patch', path: '/v1/screens/{id}', tags: ['Tenant — Screens'], summary: 'Update a screen', auth: 'tenant_admin JWT or tenant API key', requestSchema: patchScreenSchema, responseExample: { screen: {} } },
    { method: 'post', path: '/v1/screens/{id}/rotate-key', tags: ['Tenant — Screens'], summary: 'Rotate a screen device API key', auth: 'tenant_admin JWT or tenant API key', responseExample: { device_api_key: 'plaintext-shown-once' } },
    { method: 'get', path: '/v1/tenant/api-key', tags: ['Tenant — API key & usage'], summary: 'View tenant API key status', auth: 'tenant_admin JWT or tenant API key', responseExample: { key_prefix: 'abcd1234', status: 'active' } },
    { method: 'post', path: '/v1/tenant/api-key/rotate', tags: ['Tenant — API key & usage'], summary: 'Rotate tenant API key', auth: 'tenant_admin JWT or tenant API key', responseExample: { api_key: 'plaintext-shown-once' } },
    { method: 'get', path: '/v1/tenant/usage', tags: ['Tenant — API key & usage'], summary: 'Tenant-wide fulfillment quota usage', auth: 'tenant_admin JWT or tenant API key', responseExample: { used: 0, quota: 1000 } },
    { method: 'get', path: '/v1/tenant/usage/by-screen', tags: ['Tenant — API key & usage'], summary: 'Windowed fulfillment usage broken down per screen', auth: 'tenant_admin JWT or tenant API key', responseExample: { window_hours: 24, screens: [] } },
    { method: 'post', path: '/v1/fulfillments', tags: ['Device — Fulfillment'], summary: 'Request a fulfillment (reserve an eligible campaign)', auth: 'device API key', responseExample: { fulfillment_id: 'uuid', campaign_id: 'uuid', media_ref: 'https://...', reserved_expires_at: '2026-07-12T00:05:00.000Z' } },
    { method: 'post', path: '/v1/fulfillments/{id}/report', tags: ['Device — Fulfillment'], summary: 'Report a fulfillment outcome', auth: 'device API key', requestSchema: reportSchema, responseExample: { status: 'confirmed' } },
    { method: 'get', path: '/api/cron/expire-reservations', tags: ['Cron'], summary: 'Vercel Cron backstop for reservation expiry', auth: 'CRON_SECRET header', responseExample: { expired: 0 } },
